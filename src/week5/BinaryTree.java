...
public class BinaryTree extends BinaryTreeBasis
{
  ...
  public void attachLeftSubtree(BinaryTree leftTree) throws TreeException
  {
    if (isEmpty())
    {
      throw new TreeException("week5.TreeException:  Empty tree");
    }
    else if (root.getLeft() != null)
    {
      // a left subtree already exists; it should have been
      // deleted first
      throw new TreeException("week5.TreeException: " + "Cannot overwrite left subtree");
    }
    else
    {
      // assertion: nonempty tree; no left child
  ...
  public void attachRightSubtree(BinaryTree rightTree) throws TreeException
  {
    ...
    else if (root.getRight() != null)
    {
      ...
      // deleted first
      throw new TreeException("week5.TreeException: " + "Cannot overwrite right subtree");
    }
    else {
      // assertion: nonempty tree; no right child
