package week5;// ADT binary search tree.
...
// the use of the constructors from week5.BinaryTreeBasis
  ...
  // Calls: deleteNode.
    ...
    if (tNode == null)
    {
      throw new TreeException("week5.TreeException: Item not found");
    }
    else {
      KeyedItem nodeItem = (KeyedItem)tNode.getItem();
      if (searchKey.compareTo(nodeItem.getKey()) == 0)
